! function (e) {
    ...
    return function t(e, n, r) {
        ...
        2: [function (t, n, r) {
            (function (t) {
                ...
                ! function (i, o) {
                    ...
                    function t(e) {
                        return null == e ? !1 : null == e.Window ? !1 : e.constructor !== e.Window ? !1 : (D.push(e), !0)
                    }

                    function n(e) {
                        var t, n = {};
                        for (t in m) m.hasOwnProperty(t) && (n[t] = m[t]);
                        return n._origin = e || "*", n
                    }

                    function r(e) {
                        var t, n, r = s(this);
                        return a(e) ? !1 : a(r) ? !1 : (n = Array.prototype.slice.call(arguments, 1), t = c(e, n, r), t === !1 ? !1 : (_(T.top || T.self, t, r), !0))
                    }
                    ...
                    function l(t) {
                        T || (T = t || e, T.addEventListener ? T.addEventListener("message", d, !1) : T.attachEvent ? T.attachEvent("onmessage", d) : null === T.onmessage ? T.onmessage = d : T = null)
                    }
                    ...
                    function d(e) {
                        var t;
                        a(e.data) || (t = u(e), t && (p("*", t.event, t.args, e), p(e.origin, t.event, t.args, e), h(e.data, t.origin, e.source)))
                    }
                    ...
                    function h(e, t, n) {
                        var r, i;
                        for (r = D.length - 1; r >= 0; r--) i = D[r], i.closed === !0 ? D = D.slice(r, 1) : n !== i && _(i.top, e, t)
                    }

                    function y(e, t) {
                        function n(i, o) {
                            e(i, o), m.target(t).unsubscribe(r, n)
                        }
                        var r = f();
                        return m.target(t).subscribe(r, n), r
                    }
        ...
        10: [function (e, t, n) {
            ...
            function r(e, t) {
                return t ? void e.then(function (e) {
                    t(null, e)
                })["catch"](function (e) {
                    t(e)
                }) : e
            ...
            function r(e) {
                return function () {
                    var t, n = Array.prototype.slice.call(arguments),
                        r = n[n.length - 1];
                    return "function" == typeof r && (t = n.pop(), t = o(i(t))), s(e.apply(this, n), t)
                }
            }
        ...
        12: [function (e, t, n) {
            ...
            function r(e, t) {
                var n;
                return a.hasOwnProperty(e) ? null == t || i(e, t) || (n = new o({
                    type: s.HOSTED_FIELDS_ATTRIBUTE_VALUE_NOT_ALLOWED.type,
                    code: s.HOSTED_FIELDS_ATTRIBUTE_VALUE_NOT_ALLOWED.code,
                    message: 'Value "' + t + '" is not allowed for "' + e + '" attribute.'
                })) : n = new o({
                    type: s.HOSTED_FIELDS_ATTRIBUTE_NOT_SUPPORTED.type,
                    code: s.HOSTED_FIELDS_ATTRIBUTE_NOT_SUPPORTED.code,
                    message: 'The "' + e + '" attribute is not supported in Hosted Fields.'
                }), n
            }

            function i(e, t) {
                return "string" === a[e] ? "string" == typeof t || "number" == typeof t : "boolean" === a[e] ? "true" === String(t) || "false" === String(t) : !1
            }
            var o = e("../../lib/braintree-error"),
                s = e("../shared/errors"),
                a = e("../shared/constants").whitelistedAttributes;
            t.exports = r
        }, {
            "../../lib/braintree-error": 23,
            "../shared/constants": 17,
            "../shared/errors": 18
        }],
        13: [function (e, t, n) {
        ...
        14: [function (e, t, n) {
            ...
            function i(e) {
                var t, n, _, h = this,
                    ...
                    b = 0,
                    N = E();
                if (!e.client) throw new u({
                    type: v.INSTANTIATION_OPTION_REQUIRED.type,
                    code: v.INSTANTIATION_OPTION_REQUIRED.code,
                    message: "options.client is required when instantiating Hosted Fields."
                });
                if (_ = e.client.getConfiguration(), n = _.analyticsMetadata.sdkVersion, n !== g) throw new u({
                    type: v.INCOMPATIBLE_VERSIONS.type,
                    code: v.INCOMPATIBLE_VERSIONS.code,
                    message: "Client (version " + n + ") and Hosted Fields (version " + g + ") components must be from the same SDK version."
                });
                if (!e.fields) throw new u({
                    type: v.INSTANTIATION_OPTION_REQUIRED.type,
                    code: v.INSTANTIATION_OPTION_REQUIRED.code,
                    message: "options.fields is required when instantiating Hosted Fields."
                });
                I.call(this), this._injectedNodes = [], this._destructor = new o, this._fields = D, this._state = {
                    fields: {},
                    cards: A("")
                }, this._bus = new c({
                    channel: N,
                    ...
                    h._bus.teardown()
                }), this._client = e.client, m.sendEvent(this._client, "custom.hosted-fields.initialized"), Object.keys(e.fields).forEach(function (t) {
                    var n, r, i;
                    if (!f.whitelistedFields.hasOwnProperty(t)) throw new u({
                        type: d.HOSTED_FIELDS_INVALID_FIELD_KEY.type,
                        code: d.HOSTED_FIELDS_INVALID_FIELD_KEY.code,
                        message: '"' + t + '" is not a valid field.'
                    });
                    if (n = e.fields[t], r = document.querySelector(n.selector), !r) throw new u({
                    ...
                    if (r.querySelector('iframe[name^="braintree-"]')) throw new u({
                    ...
                    i = a({
                    ...
                    }), this._injectedNodes = this._injectedNodes.concat(T(i, r)), this._setupLabelFocus(t, r), D[t] = {
                        frameElement: i,
                        containerElement: r
                    }, b++, this._state.fields[t] = {
                        isEmpty: !0,
                        isValid: !1,
                        ...
                        i.src = l(_.gatewayConfiguration.assetsUrl, N, _.isDebug)
                    }, 0)
                }.bind(this)), t = setTimeout(function () {
                    m.sendEvent(h._client, "custom.hosted-fields.load.timed-out")
                }, p), this._bus.on(y.FRAME_READY, function (n) {
                    b--, 0 === b && (clearTimeout(t), n(e), h._emit("ready"))
                }), this._bus.on(y.INPUT_EVENT, r(D).bind(this)), this._destructor.registerFunctionForTeardown(function () {
                    var e, t, n;
                    for (e = 0; e < h._injectedNodes.length; e++) t = h._injectedNodes[e], n = t.parentNode, n.removeChild(t), s.remove(n, f.externalClasses.FOCUSED, f.externalClasses.INVALID, f.externalClasses.VALID)
                }), this._destructor.registerFunctionForTeardown(function () {
                    var e = S(i.prototype).concat(S(I.prototype));
                    O(h, e)
                })
            }
            var o = e("../../lib/destructor"),
                ...
                T = e("./inject-frame"),
                m = e("../../lib/analytics"),
                D = f.whitelistedFields,
                g = "3.11.1",
                S = e("../../lib/methods"),
                O = e("../../lib/convert-methods-to-error"),
                b = e("../../lib/deferred"),
                v = e("../../lib/errors"),
                A = e("credit-card-type"),
                N = e("./attribute-validation-error"),
                L = e("../../lib/promise"),
                x = e("wrap-promise");
            i.prototype = Object.create(I.prototype, {
                ...
                function n() {
                    s.emit(y.TRIGGER_INPUT_FOCUS, e)
                }
                var r, i, o = h(),
                    s = this._bus;
                if (!o && null != t.id) {
            ...
            }, i.prototype.teardown = x(function () {
                var e = this;
                return new L(function (t, n) {
                    e._destructor.teardown(function (r) {
                        m.sendEvent(e._client, "custom.hosted-fields.teardown-completed"), r ? n(r) : t()
                    })
                })
            }), i.prototype.tokenize = x(function (e) {
                var t = this;
                return e || (e = {}), new L(function (n, r) {
                    t._bus.emit(y.TOKENIZATION_REQUEST, e, function (e) {
                        var t = e[0],
                            i = e[1];
                        t ? r(t) : n(i)
                    })
                ...
                var r;
                D.hasOwnProperty(e) ? this._fields.hasOwnProperty(e) ? this._bus.emit(y.ADD_CLASS, e, t) : r = new u({
                ...
                }), "function" == typeof n && (n = b(n))(r)
            }, i.prototype.removeClass = function (e, t, n) {
                var r;
                D.hasOwnProperty(e) ? this._fields.hasOwnProperty(e) ? this._bus.emit(y.REMOVE_CLASS, e, t) : r = new u({
                    type: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.type,
                    code: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.code,
                ...
                var n, r;
                D.hasOwnProperty(e.field) ? this._fields.hasOwnProperty(e.field) ? (n = N(e.attribute, e.value), n ? r = n : this._bus.emit(y.SET_ATTRIBUTE, e.field, e.attribute, e.value)) : r = new u({
                    type: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.type,
                    code: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.code,
                ...
                }), "function" == typeof t && (t = b(t))(r)
            }, i.prototype.removeAttribute = function (e, t) {
                var n, r;
                D.hasOwnProperty(e.field) ? this._fields.hasOwnProperty(e.field) ? (n = N(e.attribute), n ? r = n : this._bus.emit(y.REMOVE_ATTRIBUTE, e.field, e.attribute)) : r = new u({
                    type: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.type,
                    code: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.code,
                ...
                var n;
                D.hasOwnProperty(e) ? this._fields.hasOwnProperty(e) ? this._bus.emit(y.CLEAR_FIELD, e) : n = new u({
                    type: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.type,
                    code: d.HOSTED_FIELDS_FIELD_NOT_PRESENT.code,
            ...
            "../../lib/classlist": 27,
            "../../lib/constants": 28,
            "../../lib/convert-methods-to-error": 29,
            "../../lib/deferred": 31,
            "../../lib/destructor": 32,
            "../../lib/errors": 34,
            "../../lib/event-emitter": 35,
            "../../lib/is-ios": 36,
            "../../lib/methods": 39,
            "../../lib/promise": 42,
            "../../lib/uuid": 44,
            "../shared/constants": 17,
            "../shared/errors": 18,
            "../shared/find-parent-tags": 19,
            "./attribute-validation-error": 12,
            "./compose-url": 13,
            "./inject-frame": 15,
            "credit-card-type": 1,
            iframer: 3,
        ...
        17: [function (e, t, n) {
            ...
            o.events = r(["FRAME_READY", "VALIDATE_STRICT", "CONFIGURATION", "TOKENIZATION_REQUEST", "INPUT_EVENT", "TRIGGER_INPUT_FOCUS", "ADD_CLASS", "REMOVE_CLASS", "SET_ATTRIBUTE", "REMOVE_ATTRIBUTE", "CLEAR_FIELD"], "hosted-fields:"), t.exports = o
        }, {
            "../../lib/enumerate": 33
        }],
        18: [function (e, t, n) {
        ...
        21: [function (e, t, n) {
            ...
            function i(e, t, n) {
                var i = e.getConfiguration(),
                    a = e._request,
                    c = r(Date.now()),
                    u = i.gatewayConfiguration.analytics.url,
                    l = {
                        analytics: [{
        ...
        41: [function (e, t, n) {
            (function (e) {
                ...
                function n(e) {
                    var t, n, r, i, o, s, a, c, u = new RegExp("^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{4})([=]{1,2})?$"),
                        l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                        f = "";
                    if (!u.test(e)) throw new Error("Non base64 encoded input passed to window.atob polyfill");
                    c = 0;
                    do i = l.indexOf(e.charAt(c++)), o = l.indexOf(e.charAt(c++)), s = l.indexOf(e.charAt(c++)), a = l.indexOf(e.charAt(c++)), t = (63 & i) << 2 | o >> 4 & 3, n = (15 & o) << 4 | s >> 2 & 15, r = (3 & s) << 6 | 63 & a, f += String.fromCharCode(t) + (n ? String.fromCharCode(n) : "") + (r ? String.fromCharCode(r) : ""); while (c < e.length);
                    return f
                }
        ...
        42: [function (e, t, n) {
            (function (n) {
                "use strict";
                var r = n.Promise || e("promise-polyfill");
                t.exports = r
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {
            "promise-polyfill": 7
